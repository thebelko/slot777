    ...
    return gulp.task('css:make-sprite', done => {
        ...
        function actionsOnTaskSkipping() {
            return actionsOnSpriteTaskSkipping({
                ...
                fileWithMixinsPath: `${tars.root}/user-tasks/css/helpers/sprite-mixins/${preprocName}-raster-sprite-mixins.${preprocExtension}`,
                done,
                errorText
            });
        }
                    ...
                    tars.require('gulp.spritesmith')(
                        Object.assign(
                            {},
                            {
                                ...
                                cssOpts: dpiConfig,
                                padding: (i + 1) * 4,
                                cssTemplate: `${cssTemplatePath}/${preprocName}.sprite-rem.mustache`
                            },
                            spritesmithConfig,
                            {
